...
counter-evidence, and a certainty grade. A Claim is not free-form model output.

## Consultation Report

The readable presentation of an approved Claim Graph for a specific audience
and life stage. It cannot introduce facts or claims absent from the graph.
