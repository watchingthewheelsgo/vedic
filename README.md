...
language tasks and cannot replace calculation or release gates.

```text
birth information
  -> canonical place, timezone, and civil time
  -> chart_record.json + chart_audit.json
  -> rectification evidence when required
  -> judgement_context.json -> claim_graph.json
...
- Repo-local `.claude/skills` for bounded interpretation and dialogue tasks
